...
public class ItemStackBuilder {
    ...
    public ItemStackBuilder withHiddenEnchants() {
        final ItemMeta meta = ITEM_STACK.getItemMeta();
    ...
    public ItemStackBuilder withHiddenAttributes() {
        final ItemMeta meta = ITEM_STACK.getItemMeta();
    ...
    public ItemStackBuilder withHiddenDurability() {
        final ItemMeta meta = ITEM_STACK.getItemMeta();
    ...
    public ItemStackBuilder clearEnchantments() {
        ITEM_STACK.getEnchantments().keySet().forEach(ITEM_STACK::removeEnchantment);
        return this;
    }
